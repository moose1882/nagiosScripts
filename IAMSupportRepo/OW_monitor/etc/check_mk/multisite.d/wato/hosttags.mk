...
[('agent',
 ...
 ('OS',
  u'OperatingSystem/OS',
  [('WINsrv', u'WindowsServer', []),
   ('LinuxSRV', u'Linux Server', []),
   ('WIN8', u'Windows Desktop', [])]),
 ('WiFi', u'/Wireless', [('wifi-01', u'wireless', ['snmp'])])]

wato_aux_tags += \
[('snmp', u'monitor via SNMP'),
 ('tcp', u'monitor via Check_MK Agent'),
 ('SQL', u'OperatingSystem/SQL')]
